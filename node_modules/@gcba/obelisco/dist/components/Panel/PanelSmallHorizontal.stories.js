...
exports.SmallPanelHorizontalColors = void 0;
// Base
...
exports.SmallPanelHorizontalColors = function () {
    return (react_1.default.createElement("div", { className: "storybook__wrapper-small-horizontal" },
        react_1.default.createElement(_1.SmallPanel, { direction: "horizontal", title: Panel_constants_1.TITLE, description: Panel_constants_1.DESCRIPTION, picture: Panel_constants_1.SMALL_PICTURE }),
        react_1.default.createElement(_1.SmallPanel, { direction: "horizontal", title: Panel_constants_1.TITLE, description: Panel_constants_1.DESCRIPTION, picture: Panel_constants_1.SMALL_PICTURE_XS })));
};
exports.SmallPanelHorizontalColors.story = { name: 'Sin accionable' };
...
//# sourceMappingURL=PanelSmallHorizontal.stories.js.map