...
exports.HighlightedPanel = exports.SmallPanel = exports.LargePanel = void 0;
...
var getVideo = function (video) {
    if (video && video.src !== undefined) {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("p", { className: "sr-only" }, video.title),
            react_1.default.createElement("video", { className: "card-img", controls: true },
                react_1.default.createElement("source", { src: video.src, type: "video/mp4" }),
                react_1.default.createElement("track", { src: video.caption, default: true, kind: "captions", srcLang: "es" }),
                react_1.default.createElement("p", null,
                    "Su navegador no soporta v\u00EDdeos HTML5. Puedes ver el video haciendo clic en",
                    ' ',
                    react_1.default.createElement("a", { href: video.src }, "este enlace"),
                    "."))));
    }
    return null;
};
var getVideoIframe = function (iframe) {
    if (iframe && iframe.src !== undefined) {
        return (react_1.default.createElement("iframe", { className: "card-img", src: iframe.src, title: iframe.title, frameBorder: "0", allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share", allowFullScreen: true }));
    }
    return null;
};
...
var LinkList = function (_a) {
    ...
    return (react_1.default.createElement("div", { className: "list-link" },
        react_1.default.createElement("h3", { className: "list-link-title" }, listLinkPanel.listTitle), (_b = listLinkPanel.links) === null || _b === void 0 ? void 0 :
...
exports.HighlightedPanel = function (props) {
    var title = props.title, description = props.description, picture = props.picture, video = props.video, iframe = props.iframe, bgColor = props.bgColor, children = props.children, _a = props.type, type = _a === void 0 ? 'banner' : _a;
    var panelClasses = classnames_1.default('card', 'card-simple', "panel-" + (type === 'banner' ? 'horizontal' : type === 'grouping' ? 'vertical' : 'lateral'));
    var HighlightedPanelContent = (react_1.default.createElement("div", { className: panelClasses.trim() },
        picture && getImage(picture),
        video && getVideo(video),
        iframe && getVideoIframe(iframe),
        react_1.default.createElement("div", { className: "card-body" },
            react_1.default.createElement("h2", { className: "card-title" }, title),
            description && react_1.default.createElement("p", { className: "card-text" }, description),
            children && react_1.default.createElement("div", { className: "panel-footer" }, children))));
    if (type === 'banner') {
        return (react_1.default.createElement("div", { className: ("panel-horizontal-content " + (bgColor !== undefined ? "bg-" + bgColor : '')).trim() }, HighlightedPanelContent));
    }
    else {
