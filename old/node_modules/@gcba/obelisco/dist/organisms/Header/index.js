...
exports.Header = exports.SECTIONS_NO_SEARCH = exports.SECTIONS_SEARCH = exports.SECTIONS_SECOND_LINE = exports.SECTIONS_FIRST_LINE = exports.USER_MOBILE = exports.USER = exports.Login = exports.SEARCH = exports.BUTTON_TOGGLER = exports.LOGO = exports.NavSection = exports.NAV_ITEM = exports.DROPDOWN_ITEM = void 0;
var react_1 = __importDefault(require("react"));
exports.DROPDOWN_ITEM = (react_1.default.createElement("li", { className: "dropdown" },
    react_1.default.createElement("button", { type: "button", className: "btn btn-dropdown btn-dropdown-lg dropdown-toggle", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" },
        react_1.default.createElement("span", { className: "btn-dropdown-text" }, "Navegaci\u00F3n"),
    ...
    react_1.default.createElement("div", { className: "dropdown-menu" },
        react_1.default.createElement("a", { className: "dropdown-item", href: "#" },
            react_1.default.createElement("span", { className: "item-text" }, "Navegaci\u00F3n")),
        react_1.default.createElement("a", { className: "dropdown-item", href: "#" },
            react_1.default.createElement("span", { className: "item-text" }, "Navegaci\u00F3n")),
        react_1.default.createElement("a", { className: "dropdown-item", href: "#" },
            react_1.default.createElement("span", { className: "item-text" }, "Navegaci\u00F3n")),
        ...
        react_1.default.createElement("a", { className: "dropdown-item", href: "#" },
            react_1.default.createElement("span", { className: "item-text" }, "Navegaci\u00F3n")),
        react_1.default.createElement("a", { className: "dropdown-item item-link", href: "#" },
            react_1.default.createElement("span", { className: "item-text" }, "Navegaci\u00F3n"),
            react_1.default.createElement("span", { className: "material-icons-round" }, "arrow_forward")))));
...
exports.LOGO = (react_1.default.createElement("a", { href: "https://buenosaires.gob.ar", className: "navbar-brand" },
    react_1.default.createElement("img", { className: "header-logo", src: "header/logotipo_ba.svg", alt: "Gobierno de la Ciudad de Buenos Aires - Inicio" })));
...
exports.SECTIONS_FIRST_LINE = (react_1.default.createElement(exports.NavSection, null,
    exports.DROPDOWN_ITEM,
    exports.NAV_ITEM,
    exports.DROPDOWN_ITEM));
exports.SECTIONS_SECOND_LINE = (react_1.default.createElement(exports.NavSection, { isExtended: true },
    exports.DROPDOWN_ITEM,
    exports.NAV_ITEM,
    exports.NAV_ITEM,
    exports.DROPDOWN_ITEM,
    ...
    exports.NAV_ITEM,
    exports.NAV_ITEM));
exports.SECTIONS_SEARCH = (react_1.default.createElement(exports.NavSection, null,
    exports.DROPDOWN_ITEM,
    exports.NAV_ITEM,
    exports.DROPDOWN_ITEM,
    exports.NAV_ITEM));
exports.SECTIONS_NO_SEARCH = (react_1.default.createElement(exports.NavSection, null,
    exports.NAV_ITEM,
    exports.DROPDOWN_ITEM,
    exports.NAV_ITEM,
    exports.DROPDOWN_ITEM,
...
exports.Header = function (_a) {
    var hasLogin = _a.hasLogin, hasProfile = _a.hasProfile, hasSearch = _a.hasSearch, isSectionExtended = _a.isSectionExtended, sections = _a.sections;
    var shouldShowButtonToggler = hasSearch || hasProfile || sections;
    var shouldShowNavbarContent = hasSearch || hasLogin || hasProfile || isSectionExtended === undefined || !isSectionExtended;
